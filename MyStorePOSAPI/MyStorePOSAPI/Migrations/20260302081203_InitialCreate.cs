        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StaffPin = table.Column<string>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CustomerId = table.Column<string>(type: "TEXT", maxLength: 16, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    OutletId = table.Column<string>(type: "TEXT", maxLength: 16, nullable: false),
                    OutletName = table.Column<string>(type: "TEXT", nullable: false),
                    Location = table.Column<string>(type: "TEXT", nullable: true),
                    ShortLocation = table.Column<string>(type: "TEXT", maxLength: 3, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    EmployeeId = table.Column<string>(type: "TEXT", maxLength: 16, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ProductId = table.Column<string>(type: "TEXT", maxLength: 16, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    InvoiceId = table.Column<string>(type: "TEXT", maxLength: 20, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    OrderId = table.Column<string>(type: "TEXT", maxLength: 16, nullable: false),
                    CustomerId = table.Column<string>(type: "TEXT", nullable: true),
                    EmployeeId = table.Column<string>(type: "TEXT", nullable: true),
                    TotalAmount = table.Column<decimal>(type: "decimal(12,2)", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    InventoryId = table.Column<string>(type: "TEXT", maxLength: 16, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SaleInvoiceLines_SaleInvoices_InvoiceId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SaleOrderId = table.Column<string>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    OrderItemId = table.Column<string>(type: "TEXT", maxLength: 16, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SaleOrderDetails", x => x.OrderItemId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Inventories_ProductId_OutletId",
                table: "Inventories",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PaymentReceipts_ApprovedById",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PaymentReceipts_SaleOrderId",
                table: "PaymentReceipts",
                column: "SaleOrderId");
